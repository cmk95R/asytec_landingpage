...
import { parseQuery, hasProtocol, joinURL, withTrailingSlash, withoutTrailingSlash } from "C:/Users/cfvhc/OneDrive/Desktop/asytec-nuxt/asytec-nuxt/node_modules/.pnpm/ufo@1.6.4/node_modules/ufo/dist/index.mjs";
...
import { u as useHead } from "./v3-c5szb61a.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-a9e50d9a><div class="fixed left-0 right-0 spotlight z-10" data-v-a9e50d9a></div><div class="max-w-520px text-center z-20" data-v-a9e50d9a><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-a9e50d9a>${ssrInterpolate(__props.status)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-a9e50d9a>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-a9e50d9a>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.21.5_@parcel+watcher_713a37508bf10f3ece778b5630f548a5/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a9e50d9a"]]);
export {
  error404 as default
};
//# sourceMappingURL=error-404-DZyjzRwE.js.map
